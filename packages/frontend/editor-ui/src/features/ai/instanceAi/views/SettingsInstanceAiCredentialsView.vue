		...
		<template v-else-if="canConfigure">
			...
			>
				<N8nSettingsRowGroup>
					...
					<N8nSettingsRow
						v-if="selectedModelCredentialId"
						:title="i18n.baseText('settings.n8nAgent.modelName.label')"
						:description="i18n.baseText('settings.n8nAgent.modelName.description')"
						:action-max-width="false"
					>
						<template #action>
							<N8nInput
								...
								autocomplete="off"
								:spellcheck="false"
								:aria-label="i18n.baseText('settings.n8nAgent.modelName.label')"
