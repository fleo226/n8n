...
import { WORKFLOW_REVIEW_REQUESTS_VIEW } from '@/features/workflowReviews/constants';
import { useWorkflowReviewsAvailable } from '@/features/workflowReviews/composables/useWorkflowReviewsAvailable';
...
const isWorkflowReviewsNavVisible = useWorkflowReviewsAvailable();
